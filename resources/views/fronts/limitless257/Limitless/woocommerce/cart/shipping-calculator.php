...
<form class="shipping_calculator clearfix" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
		...
		<div class="form-row form-row-wide">
			<div class="select-wrap"><i class="ioa-front-icon down-dir-1icon-"></i>
