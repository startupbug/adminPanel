...
/**
 * IOA Framework Based BBPress SKin
 *
 * @package IOA
...
class BBP_IOA extends BBP_Theme_Compat {
	...
	public function __construct( $properties = array() ) {
		...
		parent::__construct( bbp_parse_args( $properties, array(
			'id'      => 'IOA',
			'name'    => __( 'BBPress IOA', 'bbpress' ),
			'version' => bbp_get_version(),
			'dir'     => trailingslashit( get_template_directory() . '/external/bbpress' ),
			'url'     => trailingslashit( get_template_directory_uri() . '/external/bbpress'  ),
		), 'default_theme' ) );
...
bbp_register_theme_package( array(
			...
			'name'    => __( 'BBPress IOA', 'bbpress' ),
			'version' => bbp_get_version(),
			'dir'     => trailingslashit( get_template_directory() . '/bbpress' ),
			'url'     => trailingslashit( get_template_directory_uri() . '/bbpress'  ),
		) );
